...
use App\Controllers\EmailDigestController;
...
echo "Starting EmailDigestController CSRF test..." . PHP_EOL;

// Set up test session with admin privileges to bypass RBAC
$_SESSION['logged_in'] = true;
$_SESSION['username'] = 'test_admin';
$_SESSION['user_role'] = 'app_admin'; // Use app_admin role which has manage_alerts permission
...
$controller = new EmailDigestController();
...
echo "EmailDigestController CSRF validation tests completed with $failures failures." . PHP_EOL;
exit($failures === 0 ? 0 : 1);
